...
export const graphicsConverterTool = createTypedTool({
  ...
  inputSchema: Type.Object({
    action: Type.Union(
      ...
      {
        description:
          'Graphics conversion action. Use "convert_png_to_tiles" for basic image conversion, "create_palette" for color optimization, "generate_background" for creating SNES background layers.',
      }
    ),
    ...
    tileSize: Type.Optional(
      Type.Union(
        ...
        {
          description:
            'Tile size: "8x8" for backgrounds, "16x16" for sprites, "32x32" for large sprites',
        }
      )
    ),
    colorMode: Type.Optional(
      Type.Union(
        ...
        {
          description:
            'SNES color depth: "2bpp" (4 colors), "4bpp" (16 colors, most common), "8bpp" (256 colors), "mode7" (256 colors with rotation)',
        }
      )
    ),
    compressionType: Type.Optional(
      Type.Union(
        ...
        {
          description:
            'Compression: "none" for uncompressed (fastest), "rle" for simple compression, "lz4" for better compression',
        }
      )
    ),
